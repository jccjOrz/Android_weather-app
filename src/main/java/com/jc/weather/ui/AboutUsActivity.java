...
import com.jc.weather.databinding.ActivityAboutUsBinding;
...
public class AboutUsActivity extends BaseVBActivity<ActivityAboutUsBinding> implements View.OnClickListener {
     ...
     * 源码地址
     */
    private final String GITHUB_URL = "https://github.com/jccjOrz/Android-Weather-App";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_copy_email://复制邮箱
                ...
                ClipData myClip = ClipData.newPlainText("text", "2425796900@qq.com");
