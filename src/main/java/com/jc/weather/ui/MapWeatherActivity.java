...
import com.jc.weather.adapter.SevenDailyAdapter;
import com.jc.weather.adapter.TodayDetailAdapter;
...
import com.jc.weather.bean.SunMoonResponse;
import com.jc.weather.bean.TodayDetailBean;
import com.jc.weather.contract.MapWeatherContract;
import com.jc.weather.databinding.ActivityMapWeatherBinding;
...
import com.jc.weather.view.horizonview.Scrojcatched;
import com.jc.weather.view.horizonview.Scrojcatcher;
import com.jc.library.mvp.MvpVBActivity;

import java.util.ArrayList;
import java.util.List;

import static com.jc.weather.utils.DateUtils.getNowDateNoLimiter;
import static com.jc.weather.utils.DateUtils.updateTime;
...
public class MapWeatherActivity extends MvpVBActivity<ActivityMapWeatherBinding, MapWeatherContract.MapWeatherPresenter>
    ...
    List<Scrojcatcher> watcherList;//滑动监听列表
    private Scrojcatched watched;//滑动监听对象
    ...
    private void initScrollListener() {
        ...
        watched = new Scrojcatched() {
            @Override
            public void addWatcher(Scrojcatcher watcher) {
                watcherList.add(watcher);
            }

            @Override
            public void removeWatcher(Scrojcatcher watcher) {
                watcherList.remove(watcher);
            }

            @Override
            public void notifyWatcher(int x) {
                for (Scrojcatcher watcher : watcherList) {
                    watcher.update(x);
                }
            }
        };
